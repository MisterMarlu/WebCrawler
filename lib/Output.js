...
class Output extends BaseModule {
  ...
  constructor() {
    ...
    this.logger = null;
    this.logFileName = (typeof this.logFileName === 'undefined') ? '' : this.logFileName;
    this.logPath = (typeof this.logPath === 'undefined') ? '' : this.logPath;
   ...
   *
   * @param {string} [name=] Name of the log file. Default is the name defined in a genConfig.json.
   */
  initLogger(name = '') {
    if (!name) name = this.logFileName;
