...
let output = new Output(),
  search = new Search(config.search),
...
Crawler.prototype.endCrawling = async function (outputType) {
  ...
  try {
    screenshotString = await screenshot.doScreenshots(this.customers.withWebsite, this.debug);
  } catch (error) {
    console.log(error);
  }
  ...
  output.writeLine(screenshotString, true, 'dim');
