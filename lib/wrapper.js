...
const fs = require('fs'),
  ...
  {parseInput, isDebug, Formatter} = require(`${__dirname}/parser`),
...
class Wrapper extends Module {
  ...
  setCallback(name, callback) {
    this.output.writeConsole(`${moduleName}.setCallback - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
  ...
  addConfig(pathToConfig, name) {
    this.output.writeConsole(`${moduleName}.addConfig - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
  ...
  addModule(pathToModule, name) {
    this.output.writeConsole(`${moduleName}.addModule - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
   ...
   */
  searchForConfig() {
    this.output.writeConsole(`${moduleName}.searchForConfig - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
   ...
   */
  databaseCheck() {
    this.output.writeConsole(`${moduleName}.databaseCheck - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
    let isSet = false,
  ...
  crawl(options, logFileName = this.output.logFileName) {
    this.output.writeConsole(`${moduleName}.crawl - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
  ...
  async startCrawling() {
    this.output.writeConsole(`${moduleName}.startCrawling - File: ${__filename} - Line: ${__line}`, isDebug(Global.get('DEBUG'), moduleName), 'debug');
