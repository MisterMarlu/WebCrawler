...
QueryBuilder.prototype.query = function (prepared, values, callback) {
  this.resetQuery();
...
QueryBuilder.prototype.openConnection = function () {
  connection.connect();
};

QueryBuilder.prototype.closeConnection = function () {
  connection.end();
};
...
QueryBuilder.prototype.field = function () {
  ...
  } else if (args[0] instanceof QueryBuilder) {
...
QueryBuilder.prototype.execute = function (callback) {
  ...
  return this.query(this.getQuery(), this.getVals(), callback);
};
