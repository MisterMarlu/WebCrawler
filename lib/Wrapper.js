...
class Wrapper extends BaseModule {
   ...
   * The configuration file must be a .json file. Look at the local genConfig.json to get the format.
   *
   ...
   *
   * @param {string} logFileName Name of the log file. Default is the name defined in a genConfig.json.
   */
